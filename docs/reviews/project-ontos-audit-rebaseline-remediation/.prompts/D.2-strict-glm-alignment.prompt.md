...
`docs/reviews/project-ontos-audit-rebaseline-remediation/.raw/audit-rb-D2-gla.review.md`;
the lifecycle wrapper will validate and promote those exact bytes. End your
final response with the literal line
`Wrote \`docs/reviews/project-ontos-audit-rebaseline-remediation/.raw/audit-rb-D2-gla.review.md\``
