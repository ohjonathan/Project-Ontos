...
Frozen-path diagnose-only mode is covered in practice by
`scanning.skip_patterns`; receipt/baseline invalidation depends on
#173/#174.
...
## 5. Value Frame: Multi-Worktree / Multi-Device Agentic Work
