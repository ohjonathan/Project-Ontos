---
id: project_ontos_v5_0_3_log_paths_tracker
type: tracker
status: scaffold
owner: Project Ontos Maintainers
depends_on:
  - project_ontos_v5_0_3_log_paths_proposal
concepts:
  - proposals
  - config
  - workflow
...
# Project Ontos v5.0.3 Log Paths — Tracker

| Phase | Owner | Status | Artifact | Evidence | Timestamp |
|-------|-------|--------|----------|----------|-----------|
| 0 — child scaffold | orchestrator | scaffolded | `manifests/project-ontos-v5-0-3-log-paths.yaml`; proposal; tracker | Parent split assigns the shared log-path contract and exactly seven #149 wrappers; no Phase A or implementation authority is claimed | 2026-07-15 |
