...
Evidence modes: `strict-P3` | `provider-limited` | `—`. Release outcome values are
`strict_p3_review_complete` or `provider_limited_fallback_complete`; certification and
release-action caveats are recorded separately so that later maintainer action does not
rewrite the historical review evidence.
...
| project-ontos-audit-relN-quick-wins | #148 | v4.8.0 | open / not started (v4.7.1 release-integrity slice landed; broad program remains) | — | — | 2026-07-12 |
| project-ontos-audit-relN-sweep | #149 | v4.8.0 | open / not started (v4.7.1 activation slice landed; broad program remains) | — | — | 2026-07-12 |
