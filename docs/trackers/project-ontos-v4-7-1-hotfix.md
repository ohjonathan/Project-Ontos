...
| C | codex | completed | `30d8dcd811f2d03552f8a24bc6f05b57e4d19e13` | Product fixes are in `a0062ae`; later test-only refs make doctor and compatibility CI hermetic/current without changing the product contract; 82 focused plus final full-suite verification | 2026-07-12 |
