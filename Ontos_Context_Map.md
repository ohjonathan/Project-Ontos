...
generated: "2026-04-04 22:18:18 UTC"
mode: Contributor
...
# Ontos Context Map
Generated on: 2026-04-04 18:18:18
...
- **ontos_manual** [L2] (Ontos_Manual.md) ~4,900 tokens
  - Status: active
  - Depends On: None
...
- **v3_4_compact_tiered_spec** [L2] [draft] (v3.4_spec.md) ~2,800 tokens
  - Status: draft
  - Depends On: tiered_context_loading_assessment
...
## 2. Recent Timeline
- **v3.4.0.md** [release] **V3.4.0** (`v340`)
  - Concepts: compact, tiered, context-map
- **v3.3.1.md** [release] **V3.3.1** (`v331`)
...
- **2026-04-04** [chore] **Init** (`log_20260404_init`)
- **2026-03-01** [fix] **Tiered Final Cleanup And Merge** (`log_20260301_tiered-final-cleanup-and-merge`)
- **2026-02-22** [feature] **Add Promote Check Task To Ontos Maintain** (`log_20260222_add-promote-check-task-to-ontos-maintain`)
  - Impacted: `ontos_manual`, `ontos_agent_instructions`
  - Concepts: maintain, curation, promote
- **2026-02-12** [fix] **V3 3 1 External Review Remediation Complete Merged** (`log_20260212_v3-3-1-external-review-remediation-complete-merged`)
- **2026-02-12** [chore] **Init** (`log_20260212_init`)
- **2026-02-12** [fix] **External Review Remediation Implemented 9 Point V3** (`log_20260212_external-review-remediation-implemented-9-point-v3`)

*Showing 10 of 55 sessions*
...
- [BROKEN LINK] **v3_4_compact_tiered_spec** (/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.4/v3.4_spec.md) references missing ID: `tiered_context_loading_assessment`
  Fix: Add a document with `id: tiered_context_loading_assessment` or remove it from depends_on
...
- [LINT] **install_experience_technical_debt_proposal**: Draft proposal is 78 days old. Approve (move to strategy/) or reject (move to archive/proposals/).
- [LINT] **proposals_naming_conventions**: Active document in proposals/. Graduate to strategy/.
- [LINT] **maintain_command_v3_proposal**: Draft proposal is 78 days old. Approve (move to strategy/) or reject (move to archive/proposals/).
...
| log_20260212_init | [2026-02-12_init.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/logs/2026-02-12_init.md) | log |
...
| log_20260404_init | [2026-04-04_init.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/logs/2026-04-04_init.md) | log |
...
| v3_4_compact_tiered_spec | [v3.4_spec.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.4/v3.4_spec.md) | strategy |
