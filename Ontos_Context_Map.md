...
generated: "2026-01-29 23:57:09 UTC"
mode: Contributor
...
# Ontos Context Map
Generated on: 2026-01-29 18:57:09
...
- **ontos_manual** [L2] (Ontos_Manual.md) ~4,700 tokens
  - Status: active
  - Depends On: None
...
- **v3_2_candidate_suggestions_exploration** [L1] [draft] (candidate_suggestions_exploration.md) ~1,900 tokens  ⚠️ draft
  - Status: draft
  - Depends On: None
- **v3_2_chief_architect_response** [L2] (v3.2_Chief_Architect_Response.md) ~2,600 tokens
  - Status: complete
  - Depends On: v3_2_spec_review_consolidation
...
- **v3_2_env_detection_candidate_suggestions_implementation_plan** [L2] (v3.2_Env_Detection_Candidate_Suggestions_Implementation_Plan.md) ~11,000 tokens
  - Status: approved
  - Depends On: v3_2_environment_manifest_detection_proposal, v3_2_candidate_suggestions_exploration
...
- **v3_2_final_approval_chief_architect** [L2] (v3.2_Final_Approval_Chief_Architect.md) ~844 tokens
  - Status: active
  - Depends On: v3_2_code_verification_codex, v3_2_code_review_consolidation
- **v3_2_implementation_prompt** [L2] (v3.2_Implementation_Prompt.md) ~2,300 tokens
  - Status: ready
  - Depends On: v3_2_env_detection_candidate_suggestions_implementation_plan, v3_2_chief_architect_response
...
- **v3_2_ontos_activation_ca_response** [L2] (v3.2_Chief_Architect_Response.md) ~3,600 tokens
  - Status: complete
  - Depends On: v3_2_ontos_activation_review_consolidation
- **v3_2_ontos_activation_implementation_prompt** [L2] (v3.2_Implementation_Prompt_Antigravity.md) ~7,000 tokens
  - Status: ready
  - Depends On: v3_2_ontos_activation_proposal, v3_2_ontos_activation_ca_response
- **v3_2_ontos_activation_proposal** [L1] (v3.2_ontos_activation.md) ~4,300 tokens  ⚠️ approved
  - Status: approved
  - Depends On: None
...
- **v3_2_re_architecture_support_proposal** [L2] (v3.2_Re-Architecture_Support.md) ~5,800 tokens
  - Status: active
  - Depends On: mission, constitution, ontos_agent_instructions
...
- **v3_2_code_review_alignment_claude** [L2] (v3.2_Code_Review_Alignment_Claude.md) ~1,800 tokens
  - Status: complete
  - Depends On: v3_2_ontos_activation_proposal, v3_2_ontos_activation_ca_response
- **v3_2_code_review_claude** [L2] (v3.2_Code_Review_Claude.md) ~1,900 tokens
  - Status: complete
  - Depends On: v3_2_implementation_spec
- **v3_2_spec_review_alignment_claude** [L2] (v3.2_Spec_Review_Alignment_Claude.md) ~2,900 tokens
  - Status: complete
  - Depends On: v3_2_ontos_activation_proposal
- **v3_2_spec_review_claude** [L2] (v3.2_Spec_Review_Claude.md) ~2,700 tokens
  - Status: complete
  - Depends On: v3_2_env_detection_candidate_suggestions_implementation_plan
...
## 3. Dependency Audit
- [BROKEN LINK] **v3_2_chief_architect_response** (/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Chief_Architect_Response.md) references missing ID: `v3_2_spec_review_consolidation`
  Fix: Add a document with `id: v3_2_spec_review_consolidation` or remove it from depends_on
- [BROKEN LINK] **v3_2_final_approval_chief_architect** (/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_rearchitecting/v3.2_Final_Approval_Chief_Architect.md) references missing ID: `v3_2_code_verification_codex`
  Fix: Add a document with `id: v3_2_code_verification_codex` or remove it from depends_on
...
- [BROKEN LINK] **v3_2_ontos_activation_ca_response** (/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_Chief_Architect_Response.md) references missing ID: `v3_2_ontos_activation_review_consolidation`
  Fix: Add a document with `id: v3_2_ontos_activation_review_consolidation` or remove it from depends_on
...
- [DEPTH] **v3_1_1_implementation_prompt_antigravity** has dependency depth 6 (max: 5)
  Fix: Refactor to reduce nesting or increase MAX_DEPENDENCY_DEPTH in ontos_config.py
- [DEPTH] **v3_2_final_approval_chief_architect** has dependency depth 9 (max: 5)
  Fix: Refactor to reduce nesting or increase MAX_DEPENDENCY_DEPTH in ontos_config.py
...
- [LINT] **v3_2_re_architecture_support_proposal**: Graduated proposal may not be in decision_history.md.
...
- [LINT] **v3_2_env_detection_candidate_suggestions_implementation_plan**: Invalid status 'approved'. Use one of: active, archived, complete, deprecated, draft, pending_curation, rejected, scaffold
- [LINT] **v3_2_pr_review_chief_architect**: Active document in proposals/. Graduate to strategy/.
- [LINT] **v3_2_final_approval_chief_architect**: Active document in proposals/. Graduate to strategy/.
- [LINT] **v3_2_implementation_prompt**: Invalid status 'ready'. Use one of: active, archived, complete, deprecated, draft, pending_curation, rejected, scaffold
...
- [LINT] **v3_2_ontos_activation_proposal**: Invalid status 'approved'. Use one of: active, archived, complete, deprecated, draft, pending_curation, rejected, scaffold
- [LINT] **v3_2_ontos_activation_implementation_prompt**: Invalid status 'ready'. Use one of: active, archived, complete, deprecated, draft, pending_curation, rejected, scaffold
...
| v3_2_candidate_suggestions_exploration | [candidate_suggestions_exploration.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/candidate_suggestions_exploration.md) | strategy |
| v3_2_chief_architect_response | [v3.2_Chief_Architect_Response.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Chief_Architect_Response.md) | strategy |
| v3_2_code_review_alignment_claude | [v3.2_Code_Review_Alignment_Claude.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_Code_Review_Alignment_Claude.md) | atom |
...
| v3_2_env_detection_candidate_suggestions_implementation_plan | [v3.2_Env_Detection_Candidate_Suggestions_Implementation_Plan.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Env_Detection_Candidate_Suggestions_Implementation_Plan.md) | strategy |
| v3_2_environment_manifest_detection_proposal | [v3.2_Environment_Manifest_Detection_Proposal.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Environment_Manifest_Detection_Proposal.md) | strategy |
| v3_2_final_approval_chief_architect | [v3.2_Final_Approval_Chief_Architect.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_rearchitecting/v3.2_Final_Approval_Chief_Architect.md) | strategy |
| v3_2_implementation_prompt | [v3.2_Implementation_Prompt.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Implementation_Prompt.md) | strategy |
...
| v3_2_ontos_activation_ca_response | [v3.2_Chief_Architect_Response.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_Chief_Architect_Response.md) | strategy |
| v3_2_ontos_activation_implementation_prompt | [v3.2_Implementation_Prompt_Antigravity.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_Implementation_Prompt_Antigravity.md) | strategy |
| v3_2_ontos_activation_proposal | [v3.2_ontos_activation.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_ontos_activation.md) | strategy |
...
| v3_2_re_architecture_support_proposal | [v3.2_Re-Architecture_Support.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/v3.2_Re-Architecture_Support.md) | strategy |
| v3_2_spec_review_alignment_claude | [v3.2_Spec_Review_Alignment_Claude.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_ontos_activation/v3.2_Spec_Review_Alignment_Claude.md) | atom |
| v3_2_spec_review_claude | [v3.2_Spec_Review_Claude.md](/Users/jonathanoh/Dev/Ontos-dev/.ontos-internal/strategy/proposals/v3.2/v3.2_detection/v3.2_Spec_Review_Claude.md) | atom |
