...
This script generates a markdown specification document from the canonical
ontology definitions in ontology.py. The generated file should NOT be
edited directly - regenerate it when ontology.py changes.
...
def main():
    """Generate and write the ontology specification."""
    spec = generate_spec()
