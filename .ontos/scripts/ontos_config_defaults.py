...
# Valid status values (v4.6: mirrors ontology.py lifecycle/support vocabulary)
VALID_STATUS = {
...
STATUS_DEFINITIONS = {
    ...
    'completed': 'Finished lifecycle artifact or completed work record',
    'auto-generated': 'Generated by Ontos or a trusted automation',
    'in_progress': 'Work is actively underway',
    'proposed': 'Lifecycle artifact has been proposed but not accepted',
    'ready': 'Lifecycle artifact is ready for the next handoff or gate',
    'revised': 'Lifecycle artifact has incorporated review changes',
    'in-lifecycle': 'Lifecycle artifact remains active in a managed workflow',
}
