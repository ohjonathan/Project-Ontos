...
You are tasked with implementing **v2.9.4** of Project Ontos—the final release of the v2.9 milestone. All core features are complete. Your job is **documentation, testing, and polish**.
...
|----|---------|---------|--------|
| **#31** | Schema Versioning | v2.9.0 | ✅ MERGED |
| **#33** | Curation Levels | v2.9.1 | ✅ MERGED |
| **#34** | Deprecation Warnings | v2.9.2 | ✅ MERGED |
| **#35** | install.py Bootstrap | v2.9.3 | ✅ MERGED |
| **#36** | Documentation & Release | v2.9.4 | 🔄 **YOU ARE HERE** |
...
curl -LO https://github.com/ohjonathan/Project-Ontos/releases/download/v2.9.4/ontos-bundle.tar.gz
...
1. Clone: `git clone https://github.com/ohjonathan/Project-Ontos.git /tmp/ontos`
...
**Note:** Import warnings from `ontos_lib` are intentionally NOT suppressible—they remind developers to migrate to `ontos.core` before v3.0.
