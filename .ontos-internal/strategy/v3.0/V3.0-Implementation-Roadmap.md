...
|---------|-------|-------|--------|
| Pre-alpha | Golden Master Testing | 0 | Not Started |
| v3.0.0-alpha | Package Structure | 1 | Not Started |
| v3.0.0-beta | Core Decomposition | 2 | Not Started |
| v3.0.0-rc | Configuration & Init | 3 | Not Started |
| v3.0.0 | Full CLI Release | 4 | Not Started |
...
|-------------|-------------|
| `io/toml.py` | TOML load/write with tomli/tomllib compatibility |
...
### 5.6 `.ontos.toml` Default Template
...
| 2 | God Script Decomposition | 5-8 | **High** | Complex extraction |
...
Given Phase 2 complexity and unknowns:
- **Optimistic:** 15 days
- **Realistic:** 22 days
- **Pessimistic:** 30 days

**Recommendation:** Plan for 20-25 days to v3.0.0.
...
| Phase | Exit Criteria |
|-------|---------------|
| 0 | Golden Master tests capturing v2.9.x behavior |
| 1 | `pip install -e .` works, tests pass |
| 2 | God Scripts decomposed, Golden Master passes |
| 3 | `ontos init` creates valid config, hooks install |
| 4 | All commands work, ready for PyPI |
| 5 | Published to PyPI, documentation complete |
