...
| **v2.8.3** | **#27** | **Complete `ontos_end_session.py` to A+** | Target: A+ | 🔲 In Progress |
| v2.8.4 | #28 | Refactor remaining scripts | — | 🔲 Planned |
| v2.8.5 | #29 | Unified CLI (`ontos.py`) | — | 🔲 Planned |
...
- Create `ontos.py` dispatcher in project root
- Implement command routing (Section 3)
- Add aliases
