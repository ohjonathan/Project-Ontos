...
1. **Single source:** All type/field definitions live in `ontology.py`
...
- [x] All tests pass (303 passed)
- [x] `ontology.py` < 150 lines (~120 lines)
- [x] `ontos_generate_ontology_spec.py` < 100 lines (~80 lines)
- [x] `ontology_spec.md` generated and committed
- [x] Behavior changes documented (Section 1.4)
...
- Created `ontology.py` with TypeDefinition, FieldDefinition dataclasses
- Updated `__init__.py` to export ontology module
- Created `ontos_generate_ontology_spec.py` generator script
- Updated `ontos_config_defaults.py` with sys.path fix and imports
- Generated `ontology_spec.md`
- All 303 tests passed

---

## Appendix: Line Count Estimates (Revised)

| File | Estimated Lines | Actual Lines |
|------|-----------------|--------------|
| `ontology.py` | ~120 | ~120 |
| `ontos_generate_ontology_spec.py` | ~70 | ~80 |
| `ontology_spec.md` | ~80 | ~60 |

**Total new code:** ~190 lines (down from ~270)
