...
1. **Zero-Dependency (v2.x)** - Tools run on Python Standard Library only
2. **System Package (v3.x)** - Distribution via PyPI with optional dependencies
...
As of v2.9.6 (PR #38), this module is the **canonical definition** for:
